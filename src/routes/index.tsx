...
import { LineChart, Globe2, Lock, Users, ArrowRight, Check } from "lucide-react";
...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "Web Development, Apps, SEO & Digital Marketing in Andhra Pradesh & Telangana | 100 Web Technologies",
      },
      {
        name: "description",
        content:
          "100 Web Technologies provides website development, mobile app development, SEO and digital marketing for businesses across Andhra Pradesh and Telangana, including Hyderabad, Vijayawada, Visakhapatnam and Tirupati.",
      },
      {
        name: "keywords",
        content:
          "web development Andhra Pradesh, website development Telangana, mobile app development Hyderabad, SEO services Andhra Pradesh, digital marketing Telangana, web development Vijayawada, app development Visakhapatnam",
      },
      {
        property: "og:title",
        content: "Web Development, Apps, SEO & Digital Marketing in Andhra Pradesh & Telangana",
      },
      {
        property: "og:description",
        content:
          "Website, app, SEO and digital marketing services for growth-focused businesses across Andhra Pradesh and Telangana.",
      },
    ],
...
const homepageServices = [...services].sort((first, second) => {
  ...
  return (
    (firstPosition === -1 ? homepageServiceOrder.length : firstPosition) -
    (secondPosition === -1 ? homepageServiceOrder.length : secondPosition)
  );
});

const primaryServiceCardDetails: Record<
  string,
  { eyebrow: string; description: string; overlay: string }
> = {
  "website-development": {
    eyebrow: "Digital experiences",
    description: "Fast, conversion-ready websites designed to grow your business.",
    overlay: "from-black/80 via-[#30133f]/35 to-transparent",
  },
  "mobile-app-development": {
    eyebrow: "Mobile products",
    description: "iOS and Android apps built for seamless customer experiences.",
    overlay: "from-[#071c3d]/90 via-[#0d6f9c]/40 to-transparent",
  },
  "digital-marketing": {
    eyebrow: "Growth marketing",
    description: "Campaigns that turn attention into qualified business opportunities.",
    overlay: "from-[#3f1020]/90 via-[#d1435c]/35 to-transparent",
  },
  seo: {
    eyebrow: "Search visibility",
    description: "SEO strategies that help the right customers find your business.",
    overlay: "from-[#08373f]/90 via-[#159577]/35 to-transparent",
  },
};
...
const localSeoFaqs = [
  {
    question: "What services does 100 Web Technologies provide in Andhra Pradesh and Telangana?",
    answer:
      "We provide website development, mobile app development, SEO, digital marketing, e-commerce and custom software services for businesses across Andhra Pradesh and Telangana.",
  },
  {
    question: "Do you work with businesses in Hyderabad, Vijayawada and Visakhapatnam?",
    answer:
      "Yes. We work remotely and collaboratively with businesses across Hyderabad, Vijayawada, Visakhapatnam, Tirupati, Guntur, Warangal and surrounding cities.",
  },
  {
    question: "Can you help a local business improve Google and AI-search visibility?",
    answer:
      "Yes. We combine technically sound websites, location-relevant service content, structured data, helpful FAQs, accurate business information and SEO strategy to improve discoverability in traditional and AI-powered search experiences.",
  },
];
    ...
    "@graph": [
      {
        ...
        url: "https://100web.in",
        description:
          "Website development, mobile app development, SEO and digital marketing services for businesses in Andhra Pradesh and Telangana.",
        areaServed: [
    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <main className="flex flex-col [&>section]:order-5 md:[&>section]:order-none">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 pb-48 sm:px-6 md:grid-cols-2 lg:px-8">
            ...
            <div className="hero-float relative z-10 max-w-xl rounded-xl bg-[#f4f2fa]/95 p-8 shadow-[0_30px_60px_-20px_rgba(10,31,68,0.35)] ring-1 ring-white/60 sm:p-10 md:p-11">
              ...
              <p className="mt-5 max-w-lg text-base text-[#0A1F44]/75 sm:text-lg">
                Modernize faster and grow more efficiently with one experienced team for websites,
            ...
            <div className="relative hidden h-[420px] md:block">
              <svg
                viewBox="0 0 600 460"
                className="hero-drift absolute inset-0 h-full w-full drop-shadow-[0_20px_30px_rgba(10,31,68,0.35)]"
              ...
              >
                ...
                {/* Cyan cable */}
                <path
                  d="M 40 120 C 200 80, 340 260, 560 200"
                  stroke="#3BC9F5"
                  strokeWidth="10"
                  fill="none"
                  strokeLinecap="round"
                ...
                {/* Thin black line */}
                <path
                  d="M 60 140 C 220 100, 360 280, 580 220"
                  stroke="#0A1F44"
                  strokeWidth="1.5"
                  fill="none"
                />
                {/* Second cable */}
                <path
                  d="M 100 380 C 260 340, 400 440, 590 360"
                  stroke="#3BC9F5"
                  strokeWidth="10"
                  fill="none"
                  strokeLinecap="round"
        ...
        <section id="solutions" className="!order-2 border-b bg-white md:order-none">
          <div
            className="technology-marquee overflow-hidden border-y border-slate-100 py-3 sm:py-4"
          ...
          >
            <div className="technology-marquee-track flex w-max flex-nowrap gap-2.5 sm:gap-3">
              {[0, 1].map((copy) => (
                <ul
                  key={copy}
                  className="flex flex-nowrap gap-2.5 sm:gap-3"
                  aria-hidden={copy === 1}
                >
                  {technologyPartners.map((partner) => (
                    <li
                      key={`${copy}-${partner.name}`}
                      className="flex h-16 w-32 shrink-0 items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 shadow-sm transition hover:border-brand-orange/40 hover:shadow-md sm:h-20 sm:w-40 sm:rounded-xl sm:px-4"
                    >
                      <img
                        src={partner.logo}
                        alt={copy === 0 ? `${partner.name} logo` : ""}
                        className={`${partner.logoClass} max-h-10 max-w-[5.5rem] object-contain sm:max-h-12 sm:max-w-[6.5rem]`}
                        loading="lazy"
                      />
                      {partner.showName && (
                        <span className="whitespace-nowrap text-xs font-bold tracking-tight text-[#263746] sm:text-sm">
                          {partner.name}
                        </span>
                      )}
                    </li>
        ...
        <section
          id="services"
          className="!order-1 flex min-h-[calc(100svh-5.75rem)] w-full bg-black px-3 py-3 sm:px-6 sm:py-20 lg:px-8 md:block md:min-h-0 md:order-none"
        >
          <div className="mx-auto hidden max-w-7xl md:block">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-lg text-white/70">
                Catch up on the latest launches, solutions, and success stories across cloud, AI,
          ...
          <div className="mx-auto grid min-h-0 max-w-7xl flex-1 grid-cols-2 grid-rows-2 gap-2.5 sm:gap-3 md:mt-10 md:flex-none md:grid-rows-none md:gap-5 lg:grid-cols-3">
            {homepageServices.map((card) => {
              ...
              return (
                ...
                >
                  <div
                    className={`relative shrink-0 overflow-hidden bg-slate-100 ${primaryService ? "absolute inset-0 h-full" : "h-[44%] md:h-auto md:aspect-[16/10]"}`}
                  >
                    <img
                  ...
                  {primaryService && (
                    <div
                      aria-hidden
                      className={`absolute inset-0 bg-gradient-to-t ${primaryService.overlay}`}
                    />
                  )}
                  <div
                    className={`flex flex-1 flex-col justify-between p-3 sm:p-6 ${primaryService ? "absolute inset-x-0 bottom-0 z-10" : ""}`}
                  >
                    {primaryService ? (
                      <div
                        className="max-w-[14rem] text-white md:max-w-sm"
                        style={{ fontFamily: "'Segoe UI', Arial, sans-serif" }}
                      >
                        <p className="inline-flex rounded-full border border-white/30 bg-black/20 px-2.5 py-1 text-[9px] font-semibold uppercase tracking-[0.16em] text-white/95 backdrop-blur-sm md:text-[10px]">
                          {primaryService.eyebrow}
                        </p>
                        <h3
                          className="mt-2 max-w-[12.5rem] text-[1.45rem] font-black leading-[0.94] tracking-[-0.045em] text-white drop-shadow-[0_3px_14px_rgba(0,0,0,0.95)] md:mt-3 md:max-w-xs md:text-[2.25rem]"
                          style={{ fontFamily: "'Segoe UI', Arial, sans-serif" }}
                        >
                          {card.badge}
                        </h3>
                        <span
                          aria-hidden
                          className="mt-2 block h-1 w-10 rounded-full bg-brand-orange shadow-[0_2px_10px_rgba(249,115,22,0.7)] md:mt-3 md:w-14"
                        />
                        <p className="mt-2 max-w-[12.5rem] text-[11px] font-normal leading-[1.45] text-white md:max-w-xs md:text-sm">
                          {primaryService.description}
                        </p>
                        <span className="mt-3 inline-flex items-center gap-2 rounded-full bg-white px-3 py-1.5 text-[11px] font-semibold text-[#10213a] shadow-[0_8px_20px_rgba(0,0,0,0.25)] transition duration-200 group-hover:-translate-y-0.5 group-hover:bg-brand-orange group-hover:text-white md:mt-5 md:px-4 md:py-2 md:text-sm">
                          View more{" "}
                          <ArrowRight className="h-3.5 w-3.5 transition group-hover:translate-x-0.5 md:h-4 md:w-4" />
                        </span>
                      </div>
                    ) : (
                      <>
                        <div>
                          ...
                          <p className="mt-1 text-[11px] leading-[1.45] text-slate-600 sm:mt-2 sm:text-xs">
                            {card.desc}
                          </p>
                        </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 md:grid-cols-2 md:items-end">
              ...
              <p className="text-muted-foreground md:text-right">
                Deep domain expertise across regulated and high-scale sectors, delivered by
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 sm:mt-10 sm:grid-cols-3 lg:grid-cols-4">
              {industries.map((industry, index) => (
                <Link
                  ...
                  className="group overflow-hidden rounded-xl border border-slate-200 bg-card transition hover:-translate-y-0.5 hover:border-[var(--brand-orange)]/60 hover:shadow-md"
                >
                  <div
                    role="img"
                    aria-label={`${industry.name} digital solutions`}
                    className="aspect-[16/9] overflow-hidden bg-slate-100 transition duration-300 group-hover:scale-105"
                    style={{
                      backgroundImage: `url(${industryHighlights})`,
                      backgroundPosition: industryImagePositions[index],
                      backgroundSize: "400% 200%",
                    }}
                  />
                  <div className="flex items-center justify-between gap-2 px-3 py-2.5 sm:px-4 sm:py-3">
                    <span className="text-xs font-semibold leading-snug text-brand-navy sm:text-sm">
                      {industry.name}
                    </span>
        ...
        <section id="local" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">
                Built for businesses in Andhra Pradesh &amp; Telangana
              </h2>
              {/*
            ...
            */}
              <p className="mt-4 text-muted-foreground">
                100 Web Technologies helps local businesses turn ideas into practical websites, apps
                and growth campaigns — with a team that understands your market, customers and pace.
              </p>
              <ul className="mt-6 space-y-3 text-sm">
                {[
                  "Clear, local-language project communication",
                  "Online and on-site discovery sessions when needed",
                  "Solutions sized for growing businesses, not enterprise overhead",
                  "Ongoing support after your website or app goes live",
                ].map((x) => (
                  <li key={x} className="flex items-start gap-3">
                    <Check className="mt-0.5 h-4 w-4 text-[var(--brand-orange)]" />
                    {x}
                  </li>
                ))}
              </ul>
            ...
            <div
              className="relative aspect-[4/3] overflow-hidden rounded-2xl border bg-[var(--brand-navy)]"
            ...
            >
              ...
              <div className="absolute inset-0 grid grid-cols-3 gap-4 p-6 text-white">
                {[
                  ...
                  <div
                    key={x.r}
                    className="rounded-lg border border-white/10 bg-white/5 p-3 text-xs backdrop-blur"
                  >
          ...
          <section className="bg-[var(--brand-navy)] py-20 text-white">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h2 className="max-w-3xl text-3xl font-bold tracking-tight sm:text-4xl">
                Why teams choose 100 Web Technologies
              </h2>
              <div className="mt-12 grid gap-8 md:grid-cols-3">
                {[
                  {
                    icon: LineChart,
                    t: "Outcomes, not hours",
                    d: "We commit to measurable business outcomes — faster releases, lower cost, higher uptime.",
                  },
                  {
                    icon: Lock,
                    t: "Security by default",
                    d: "Every architecture starts with least-privilege, encryption and continuous compliance.",
                  },
                  {
                    icon: Users,
                    t: "Senior engineers",
                    d: "You work directly with architects and lead engineers — no handoffs to junior teams.",
                  },
                ].map(({ icon: I, t, d }) => (
          ...
          <section className="relative isolate overflow-hidden border-y bg-slate-50 py-10 sm:py-16">
            ...
            <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
              ...
              <h2 className="mt-2 text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
                Digital growth support for businesses across both states
              </h2>
              <p className="mt-4 max-w-3xl text-base leading-7 text-muted-foreground">
                From Hyderabad and Warangal to Vijayawada, Visakhapatnam, Tirupati and Guntur, we
                help businesses build useful digital products and earn visibility with clear service
                information, reliable websites and search-ready content.
              </p>
              <div className="mt-5 space-y-2 md:hidden">
                <FaqAccordion
                  items={localSeoFaqs.map((faq) => ({ q: faq.question, a: faq.answer }))}
                  defaultOpenIndex={null}
                />
              </div>
              <div className="mt-8 hidden gap-4 md:grid md:grid-cols-3">
                {localSeoFaqs.map((faq) => (
                  <article key={faq.question} className="rounded-xl border bg-white p-5 shadow-sm">
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div
            className="overflow-hidden rounded-2xl border bg-card p-8 md:p-14"
            style={{ boxShadow: "var(--shadow-elevated)" }}
          >
            <div className="grid gap-10 md:grid-cols-2 md:items-center">
              <div>
                ...
                <Link
                  to="/contact"
                  className="mt-6 inline-flex items-center gap-2 rounded-full bg-[var(--brand-orange)] px-6 py-3 text-sm font-semibold text-[var(--brand-navy)] hover:brightness-110"
                >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Link
                  to="/services"
                  className="rounded-xl border bg-background p-5 text-sm font-semibold hover:border-[var(--brand-orange)]"
                >
                  Browse services →
                </Link>
                <Link
